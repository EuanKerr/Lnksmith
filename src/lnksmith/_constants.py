...
# FILETIME epoch
# ---------------------------------------------------------------------------
# 100-ns ticks between 1601-01-01 and 1970-01-01 (FILETIME -> Unix epoch).
FILETIME_UNIX_EPOCH_DELTA = 116_444_736_000_000_000
...
# ---------------------------------------------------------------------------
# FileAttributesFlags bit names (MS-SHLLINK 2.1.2)
# ---------------------------------------------------------------------------
FILE_ATTR_NAMES = {
...
WNNC_NET_TYPES = {
    ...
    0x00170000: "WNNC_NET_PATHWORKS",
    0x00180000: "WNNC_NET_MANAGEWARE",
    0x00190000: "WNNC_NET_OBJECT_DIRE",
    ...
    0x00300000: "WNNC_NET_OBJECT_DIRE_32",
